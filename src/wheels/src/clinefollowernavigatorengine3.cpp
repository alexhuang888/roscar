...
CLineFollowerNavigatorEngine3::CLineFollowerNavigatorEngine3()
{
	m_bPaused = true;
...
int32_t CLineFollowerNavigatorEngine3::Init(void)
{
	return 1;
}

int32_t CLineFollowerNavigatorEngine3::Start(void)
{
	m_bPaused = false;
...
int32_t CLineFollowerNavigatorEngine3::Pause(void)
{
	m_bPaused = true;
	return 1;
}
...
//
void CLineFollowerNavigatorEngine3::ProcessLanes(CvSeq* lines, IplImage* pEdges, IplImage *pWorkingImage, bool bShowHoughLine, float fLastSlope, float fLastB)
{
...
int32_t CLineFollowerNavigatorEngine3::ProcessImage(IplImage *pFrame, bool bDisplayImage, float &fAngle, CvPoint &vanishingPoint)
{
	int32_t nRet = -1;
	double rho = 1;
...
int32_t CLineFollowerNavigatorEngine3::SaveImage(uint32_t nModeFlags, std::string strImagePath)
{
    m_bToSaveImage = true;
